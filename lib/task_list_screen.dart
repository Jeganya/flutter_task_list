...
import 'package:flutter_db_task_list/simple_task_form_screen.dart';
import 'package:flutter_db_task_list/task_model.dart';
                ...
                child: Card(
                  ...
                  child: ListTile(
                    ...
                    title: Row(
                      ...
                      children: [
                        Text(
                          _taskList[index].task ?? 'No Data',
                          style: TextStyle(fontSize: 18),
                        ),
                      ],
                    ),
                    subtitle: Text(
                      _taskList[index].frequency,
                      style: TextStyle(
                        fontSize: 16,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => EditTaskFormScreen()));
        },
